  ...
  LivingRoom: {
    ...
    configObjects: {
      ...
      npc1: {
        ...
        x: utils.withGrid(8),
        y: utils.withGrid(4),
        src: "./image in the game/character/picture/wx.png",
        talking: [
          {
            events: [
      ...
      npc2: {
        ...
        x: utils.withGrid(3),
        y: utils.withGrid(8),
        src: "./image in the game/character/picture/huasheng.png",
        talking: [
          {
            events: [
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(8, 7)]: [
        {
          events: [
            { type: "changeMap", map: "Toilet", x: utils.withGrid(3), y: utils.withGrid(8), direction: "up" }
          ]
        }
      ],
      // 通往阳台的门
  ...
  Bedroom: {
    ...
    configObjects: {
      ...
      suspect: {
        ...
        x: utils.withGrid(7),
        y: utils.withGrid(5),
        src: "./image in the game/character/picture/1.png",
        talking: [
          {
            events: [
